...
| moreau-cpu | >= 0.4.1 | CPU solver backend |
:::

:::{dropdown} Optional Dependencies
| Package | Version | Purpose |
|---------|---------|---------|
| moreau-cuda12 | >= 0.4.1 | GPU solver backend (CUDA 12, Python >= 3.12) |
| moreau-cuda13 | >= 0.4.1 | GPU solver backend (CUDA 13, Python >= 3.12) |
