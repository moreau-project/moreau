...
pub trait LDLConfiguration: FloatT {
    ...
    fn get_ldlsolver_config_default(
        ...
        let case = settings.ipm.direct_solve_method.as_str();
...
// This section works around the lack of trait specialisation in stable
// Rust.  We want get_ldlsolver_config to
