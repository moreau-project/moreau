...
//!
//! Usage:
//!   cargo run --release --features sdp-openblas --example bench_genpow_corrector
...
fn main() {
    ...
    let configs: &[(usize, usize)] = &[(3, 1), (8, 4), (16, 8), (32, 16), (64, 32), (128, 64)];
    let tightnesses: &[f64] = &[0.5, 0.9, 0.99, 0.999];
